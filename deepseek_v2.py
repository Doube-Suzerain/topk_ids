...
class DeepseekV2MoE(nn.Module):
    ...
    def forward(
        ...
        if not self._enable_a2a_moe:
            ...
            if (
                ...
                # print("Using dual stream for MoE layer", self.layer_id)
                ...
                # print("Using normal stream for MoE layer", self.layer_id)
            ...
            # print("Using DeepEP for MoE layer", self.layer_id)
    ...
    def forward_normal(
        ...
        if hidden_states.shape[0] == 16384 and get_tensor_model_parallel_rank() == 0:
            topk_ids_dir = "/mnt/data/zyn/topk_ids/ep8"
    ...
    def forward_deepep(
        ...
        if hidden_states.shape[0] == 16384 // self.ep_size and get_tensor_model_parallel_rank() == 0:
            topk_ids_dir = "/mnt/data/zyn/topk_ids/ep8"
            if not hasattr(self, "save_idx"):
                self.save_idx = 0
            if self.save_idx <= 5:
